![Hibiki](https://i.ibb.co/RkRRZh6D/logo.png)
...
1. **Download the docker-compose.yml file:**
   ...
   ```powershell
   Invoke-WebRequest -Uri https://raw.githubusercontent.com/bitc0de/hibiki/main/docker-compose.yml -OutFile docker-compose.yml
   ```
...
docker rmi ghcr.io/bitc0de/hibiki:latest
rm -rf data/
```
